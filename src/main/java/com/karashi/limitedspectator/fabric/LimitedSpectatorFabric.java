package com.karashi.limitedspectator.fabric;
 ...
 * 
 * This is an EXAMPLE implementation showing how Fabric integration would work.
 * Rename to .java when multi-project structure is ready.
 */
        ...
        CommandRegistrationCallback.EVENT.register((dispatcher, registryAccess, environment) -> {
            ...
            dispatcher.register(Commands.literal("spectator")
                ...
                .executes(ctx -> {
                    ...
                    player.displayClientMessage(
                        Component.literal("Spectator mode activated").withStyle(ChatFormatting.AQUA),
                        true
                    );
            ...
            dispatcher.register(Commands.literal("survival")
                ...
                .executes(ctx -> {
                    ...
                    player.displayClientMessage(
                        Component.literal("Survival mode activated").withStyle(ChatFormatting.GREEN),
                        true
                    );
